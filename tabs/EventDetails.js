...
export default class EventDetails extends Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Content>
          {this.props.navigation.state.params.event.eventImageURL ? <Image source={{ uri: this.props.navigation.state.params.event.eventImageURL }} style={{ height: 200, width: null, resizeMode: 'contain' }} /> : <Image source={require('../images/Temoc_Orange.png')}  style={{ height: 200, width: null, resizeMode: 'contain' }} />}
          <Card style={{ flex: 0 }}>
            <CardItem>
              <Body>
